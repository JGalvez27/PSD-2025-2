...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.139 2025-11-02 17:19:56 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_recv_blackJackns__getStatus(struct soap *soap, struct tBlock *result)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_blackJackns__getStatusResponse = soap_get_blackJackns__getStatusResponse(soap, NULL, "blackJackns:getStatusResponse", NULL);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_recv_blackJackns__playerMove(struct soap *soap, struct tBlock *result)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_blackJackns__playerMoveResponse = soap_get_blackJackns__playerMoveResponse(soap, NULL, "blackJackns:playerMoveResponse", NULL);
